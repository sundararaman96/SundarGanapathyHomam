(() => {
  ...
  const sealContinue = document.getElementById('sealContinue');
  ...
  sealContinue.addEventListener('click', showFullInvite);
  ...
  // The second screen intentionally waits for a press on the centre flower seal.
